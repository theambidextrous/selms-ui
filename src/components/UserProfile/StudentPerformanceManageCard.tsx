...
import { PerformanceByStudentObject } from "../../pages/Report/PerformanceByStudent";

export default function StudentPerformanceManageCard({ onGenerated, onExport } : { onGenerated: any, onExport: any}) {
  ...
  const onGenerateReport = async (values : PerformanceByStudentObject) => {
