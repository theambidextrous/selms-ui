...
import { CreateTeacherLessonSchema, TimeTableObject } from "../../pages/TimeTabling/TimeTableCalendarView";

export default function TimeTableManageCard({ selection, onExport, onRefresh } : { selection: TimeTableObject, onExport: any, onRefresh: any}) {
        ...
        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
          <div className="px-2 pr-14">
            <h4 className="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
              Add lessons for different classes and teachers
            </h4>
