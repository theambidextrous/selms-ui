...
export interface PerformanceByStudentObject  {
    id: 1,
    student: string,
    subject: string,
    group: string,
...
export default function TeacherPerformanceByStudent() {
    const gridRef = useRef(undefined);
    const [data, setData] = useState<PerformanceByStudentObject[]>();
    const [colDefs] = useState<ColDef<PerformanceByStudentObject>[]>([
