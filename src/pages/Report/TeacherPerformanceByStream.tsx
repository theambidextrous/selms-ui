...
export default function TeacherPerformanceByStream() {
    const gridRef = useRef(undefined);
    const [data, setData] = useState<PerformanceByStreamObject[]>();
    const [colDefs] = useState<ColDef<PerformanceByStreamObject>[]>([
